...
In this project, we're given bivariate data for a set of customers (income and spending score) and we're tasked with segmenting and clustering the customers into groups for another department, likely marketing or quality assurance. We use Python libraries Pandas and sklearn to perform this clustering and present data for marketing use.
